...
lines permits measurement of various microscopic phenotypes
\item summary: 
\bi
...
\ei
\begin{verbatim}
> plot_EvG(probeId("GI_17149835-I"), rsid("rs6041750"), ceu1kg[chrnum("chr20"),])
Error in .local(x, rs, ...) : rs number not found in columns of smlSet
\end{verbatim}
\bi
\item Account for revisions in dbSNP
\ei
<<doo,eval=FALSE>>=
plot_EvG(probeId("GI_17149835-I"), rsid("rs8392"), ceu1kg[chrnum("chr20"),])
@
}
