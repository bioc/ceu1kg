...
<<lk>>=
C20_MACH_FULL = m20
C20IMP_MACH = t(m20[ setdiff(colnames(m20), colnames(hm3_20gt)), ])
@
...
comm = intersect(rownames(C20IMP_MACH), colnames(C20IMP_REG))
@
...
LEGACY: use numeric
<<lki>>=
C20IMP_MACH = as(C20IMP_MACH[ imploc, comm ], "numeric")
C20IMP_REG = as(C20IMP_REG[ imploc, comm ], "numeric")
